...
def archivos_eurovoc(lista, fileEurovoc,idioma):
    ...
    n=open(fileEurovoc+'_nr.csv', 'w')
    narrower=csv.writer(n)
    r=open(fileEurovoc+'_rl.csv', 'w')
...
def parserExcel(lista, jsonlist,  csvFILE,tipo,idioma):
    ...
    print('___________PROCESO CONCLUIDO_____________')
...
parser.add_argument("--listTerm", help="Nombre de archivo con terminos") #nombre de archivo a leer
parser.add_argument("--termino", help="Termino a buscar") #nombre de archivo a leer
parser.add_argument("--typeFile", help="Tipo de lectura de archivo (w para crear inicialmente / a para leer (añadir nuevos terminos))") #tipo de archivo lectura o escritura (w/a)
parser.add_argument("--termId", help="Nombre del archivo termino-id") #nombre de archivo termino-id
parser.add_argument("--csvFILE", help="Nombre de archivo csv que contendra el resultado")
parser.add_argument("--fileEurovoc", help="Nombre de archivo csv para eurovoc")
parser.add_argument("idioma", help="Nombre de archivo csv que contendra el resultado")
parser.add_argument("api", help="Nombre de la api a utilizar (iate/eurovoc)") 
...
if(nameapi=='iate'):
    listTerm=args.listTerm
    termino=args.termino
    typeFile=args.typeFile
    termId=args.termId
    idioma=args.idioma
    csvFILE=args.csvFILE
    fileEurovoc=args.fileEurovoc
