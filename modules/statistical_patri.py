...
def main(corpus):
	...
	extractor.load_sl_stopwords("../data/stop-esp.txt")
	extractor.load_sl_inner_stopwords("../data/inner-stop-esp.txt")
	...
	out=extractor.save_term_candidates("../data/estatutoterms_mx.txt")

	return(out)

#corpus="estatuto_es.txt"
#main(corpus)