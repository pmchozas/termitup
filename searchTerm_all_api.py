...
def all(idioma,termino,targets,context, relation):
    ...
    search = requests.get("https://dictapi.lexicala.com/search?source=global&language="+idioma+"&text="+termino+"", auth=('987123456', '987123456'))
...
if(termino):
    ...
    all(idioma,termino,targets,context, relation)
...
###:termitup karenvazquez$ python3 searchterm.py "maternity leave" en --targets "en es de nl" 
###:termitup karenvazquez$ python3 searchterm.py discrimination en --targets "es en de nl"   
