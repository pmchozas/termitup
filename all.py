...
def crearRelaciones(relacion, retrieved_wikidata,  A):
    skos="skos:"+relacion
    if(skos in retrieved_wikidata.keys()):
        ...
        if(termSearchB!=''):
            ...
            dataEurovoc=fileEurovoc(termSearchB, ideB, A, '-', idioma)
            carpetas=os.listdir(idioma)
                ...
                for altLabel in retrieved_wikidata["skos:altLabel"]:
                    ...
                    if len(A):
                        ...
                        if(T_A_relationship=='related'):
                            crearRelaciones('related',retrieved_wikidata,A)
                            retrieved_wikidata["skos:altLabel"].remove(altLabel)

                        elif(T_A_relationship=='narrower'):
                            crearRelaciones('narrower',retrieved_wikidata,A)
                            retrieved_wikidata["skos:altLabel"].remove(altLabel)
                        elif(T_A_relationship=='broader'):
                            crearRelaciones('broader ',retrieved_wikidata,A)
                            retrieved_wikidata["skos:altLabel"].remove(altLabel)
